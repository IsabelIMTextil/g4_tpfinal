...
<div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card">
      <img src="../imagenes/noa_manta.jpeg" class="img-thumbnail rounded" alt="manta tejia en telar criollo" width="500"  height="500" style="border: 1px solid #000;">
      <div class="card-body">
        <h5 class="card-title"  style="width: 450px;">NOA - Noroeste Argentino</h5>
  ...
  <div class="col">
    <div class="card">
      <img src="../imagenes/noa_alforja.jpeg" class="img-thumbnail rounded" alt="alforja tejida" width="500"  height="500" style="border: 1px solid #000;">
      <div class="card-body">
        <h5 class="card-title"  style="width: 450px;">Alforja</h5>
...
<div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card">
      <img src="../imagenes/noa_poncho.jpeg" class="img-thumbnail rounded" alt="poncho tejido en telar criollo" width="500"  height="500" style="border: 1px solid #000;">
      <div class="card-body">
        <h5 class="card-title"  style="width: 450px;">Técnica textil del NOA</h5>
...
<div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card">
      <img src="../imagenes/noa_chuspa.jpeg" class="img-thumbnail rounded" alt="Chuspa" width="500"  height="500" style="border: 1px solid #000;">
      <div class="card-body">
        <h5 class="card-title"  style="width: 450px;">Chuspa para guardar hojas de coca.</h5>
...
<div class="col">
    <div class="card">
    <iframe style="border: 1px solid #000;" class="m-auto p-1" width="90%"  height="315" src="https://www.youtube.com/embed/4D-s2LdMUls?si=7D0LxyX41QOH7adH" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
      <br><br>
      <div class="col">
    <div class="card">
      <iframe style="border: 1px solid #000;" class="m-auto p-1" width="90%"  height="315" src="https://www.youtube.com/embed/zSJsVMYS-HA?si=fV1_fTxPIc1oKiLT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
</div>
